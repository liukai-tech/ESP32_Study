...
#define TAG                     "ESP-TCP"            //打印的tag

//server
//AP热点模式的配置信息
#define SOFT_AP_SSID            "ESP-TCP-SERVER"     //账号
#define SOFT_AP_PAS             "12345678"           //密码，可以为空
#define SOFT_AP_MAX_CONNECT     1                   //最多的连接点

//client
//STA模式配置信息,即要连上的路由器的账号密码
#define GATEWAY_SSID            "sunnavX"         //账号
#define GATEWAY_PAS             "20130313"       //密码
#define TCP_SERVER_ADRESS       "192.168.1.153"     //作为client，要连接TCP服务器地址
